...
export default function Navbar({ userRole, userName }) {
  ...
  const studentNavItems = [
    ...
    { href: "/student/exam-schedule", label: "Exam Schedule", icon: CalendarCheck },
  ...
  const staffNavItems = [
    ...
    { href: "/staff/attendance", label: "Manage Attendance", icon: CalendarCheck },
    { href: "/staff/assign-room", label: "Assign Room", icon: ClipboardList },
  ];

  const navItems = userRole === "student" ? studentNavItems : staffNavItems;
  const profilePath = userRole === "student" ? "/student/profile" : "/staff/profile";

  return (
    <nav className="bg-primary text-primary-foreground shadow-lg">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <Link href={userRole === "student" ? "/student/dashboard" : "/staff/dashboard"} className="text-xl font-bold">
